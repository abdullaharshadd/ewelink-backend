...
const _config = {
  appId: process.env.EWELINK_APPID, // App ID, which needs to be configured in the eWeLink open platform
  appSecret: process.env.EWELINK_APPSECRET, // App Secret, which needs to be configured in the eWeLink open platform
  region: process.env.EWELINK_REGION, //Feel free, it will be automatically updated after login
